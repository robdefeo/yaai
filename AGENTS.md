...
- **Don't Repeat Youself (DRY)**: Eliminate redundancy; maintain a single source of truth. Duplication creates divergence. Extract shared logic, use libraries, refactor repeated patterns.
